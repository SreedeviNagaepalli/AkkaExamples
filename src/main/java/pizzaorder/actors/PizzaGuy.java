...
public class PizzaGuy extends AbstractLoggingActor {
	...
	public PizzaGuy() {
		receive(ReceiveBuilder.match(TakeOrder.class, this::onTakeOrder).match(PreparePizza.class, this::onPreparePizza)
				.match(DeliverPizzas.class, this::onDeliverPizzas).build());
	}
