...
public class Office extends AbstractLoggingActor {
	...
	public Office() {
		...
		receive(ReceiveBuilder.match(StartWorkshop.class, this::onStartWorkshop)
				.match(KnockDoor.class, this::onKnockDoor).match(ReceiveOrder.class, this::onReceiveOrder).build());
	}
