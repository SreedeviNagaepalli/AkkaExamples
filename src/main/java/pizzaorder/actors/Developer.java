...
public class Developer extends AbstractLoggingActor {
	...
	public Developer(String name) {
		...
		receive(ReceiveBuilder.match(StartOrdering.class, this::onStartOrdering)
				.match(PizzaHasArrived.class, this::onPizzaHasArrived).match(EatPizza.class, this::onEatPizza).build());
	}
